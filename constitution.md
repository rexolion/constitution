...
1. Координатор должен проводить Интегративный процесс принятия решений следующим образом:
    ...
    6. Если обоснованных Возражений нет, Секретарь регистрирует Предложение как принятое Управление Круга.
    7. **Интеграция**.
...
2. Неявные ожидания или ограничения не имеют ни веса, ни влияния, ни диктатов, изданных в рамках предыдущей структуры управления Общества до принятия настоящей Конституции.
