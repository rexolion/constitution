...
1. По умолчанию Координатор Тактического собрания должен придерживаться следующего процесса:
    ...
    5. **Формирование повестки**.
        1. Координатор выстраивает повестку обработки Напряжений путем опроса всех участников; опрос должен проводиться в рамках собрания, а не заранее.
        2. Каждый участник может добавить любое количество пунктов повестки, указав для каждого короткую метку, без объяснений и обсуждений; новые пункты могут быть добавлены позже, в промежутках между обработкой существующих.
    6. **Обработка Напряжений**.
        1. Для обработки пункта повестки его инициатор может обратиться с запросом к другим участникам; применяются только обязанности, существующие независимо и исходящие от приглашенных на собрание Ролей.
