...
1. Партнер, _служащий_ Руководителем Роли, автоматически назначается на Роль «Руководитель Круга» внутреннего Круга этой Роли и действует в этом качестве.
...
### Статья 1.2. Домены
1. Выполняющий Роль обладает полномочиями использовать Домен и влиять на него, если:
    1. Домен принадлежит выполняемой Роли; или
    2. Домен принадлежит Кругу, который содержит выполняемую Роль; или
    3. Домен не делегирован другой Роли в Кругу, а сам Круг имеет право влиять на него.
...
## Статья 2.    Ответственность выполняющего Роль
1. Каждый выполняющий Роль несет ответственность, которая определена в Статьях 2.1 и 2.5 настоящего Раздела.
...
### Статья 2.3. Декомпозиция Проектов
...
### Статья 2.4. Отслеживание Проектов, Следующих действий и Напряжений
...
### Статья 2.5. Приоритетность внимания
...
## Статья 3.    Обязанности перед выполняющими Роль
1. У Руководителя Роли есть обязанности перед всеми другими лицами, выполняющими Роли в Обществе, которые определены в Статьях 3.1 - 3.3 настоящего Раздела.
2. Эти обязанности применяются только в случае, когда другая сторона действует от имени одной из своих Ролей в Обществе и называет Роль в запросе.

### Статья 3.1. Обязанность прозрачности
...
### Статья 3.2. Обязанность обработки
...
### Статья 3.3. Обязанность приоритизации
...
### Статья 4.2. Координация и процесс
...
### Статья 4.3. Суррогат для отсутствующего участника
...
## Статья 5.    Индивидуальная инициатива
...
### Статья 5.1. Разрешенные ситуации
...
### Статья 5.2. Информирование и восстановление
...
### Статья 5.3. Последствия в приоритете
